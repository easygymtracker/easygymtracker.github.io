...
const ROUTE_HEADS = new Set(["features", "privacy", "terms", "about", "routines", "routine", "session", "profile", "profile-history", "exercise"]);
...
function parseCurrentRoute() {
    ...
    if (parts[0] === "terms") return { name: "terms", params: {} };
